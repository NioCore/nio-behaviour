...
def main():
    Experiment().startExperiment(100, 5, 5, False, False, False, False)
    Experiment().startExperiment(100, 5, 5, False, True, False, False)
    Experiment().startExperiment(100, 5, 5, False, False, True, False)
    Experiment().startExperiment(100, 5, 5, False, False, False, True)
    Experiment().startExperiment(100, 5, 5, False, True, True, True)

    Experiment().startExperiment(100, 5, 5, True, False, False, False)
    Experiment().startExperiment(100, 5, 5, True, True, False, False)
    Experiment().startExperiment(100, 5, 5, True, False, True, False)
    Experiment().startExperiment(100, 5, 5, True, False, False, True)
    Experiment().startExperiment(100, 5, 5, True, True, True, True)

    Experiment().startExperiment(100, 6, 10, True, False, False, False)
    Experiment().startExperiment(100, 6, 10, True, True, False, False)
    Experiment().startExperiment(100, 6, 10, True, False, True, False)
    Experiment().startExperiment(100, 6, 10, True, False, False, True)
    Experiment().startExperiment(100, 6, 10, True, True, True, True)

    # Experiment().startExperiment(3, 5, 5, False, False, False)
    # Experiment().startExperiment(50, 3, 6)
    # Experiment().startExperiment(20, 3, 10)
    # Experiment().startExperiment(10, 3, 15)
    # Experiment().startExperiment(10, 3, 20)
